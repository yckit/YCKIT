...
<div class="layout-box">
	...
	<div class='layout-body'>
		<form action="?action=page&do=comment_<!--{$mode}-->" method="post" enctype="multipart/form-data" name="comment_info" onsubmit="return check()">
		<input type="hidden" name="comment_id" value="<!--{$comment.id}-->"/>
		<table width="100%" cellspacing="0" cellpadding="0">
		<tr>
		<td width="100">(评论内容)</td>
		<td align="right">
			<b style="color:#ccc">评论对象</b>：<a href="?action=page&do=page_edit&page_id=<!--{$comment.page_id}-->"><!--{$comment.page_title}--></a>
			&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
		</tr>
		</table>
